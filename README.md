...
# Below is an example for full waveform inversion of passive seismic data (the sources are indicated on the top velocity model)
Generated by [demos/test_pfwi_vel2d](https://github.com/chenyk1990/pywave/tree/main/demos/test_pfwi_vel2d.py)

<p align="center">
<img src='https://github.com/chenyk1990/gallery/blob/main/pywave/test_pfwi_vel2d_one.png' alt='comp' width=960/>
